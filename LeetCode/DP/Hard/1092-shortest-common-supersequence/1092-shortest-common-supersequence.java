class Solution {
    ...
    public String tabulization(String text1, String text2){
        ...
        while( i < m && j < n){
            if(text1.charAt(i) == text2.charAt(j)){
                ...
                //we are skipping ith character , so we add it
        ...
        //adding remaining character if one reaches boundary earlier
        while(i < m) sb.append(text1.charAt(i++));
        while(j < n) sb.append(text2.charAt(j++));
